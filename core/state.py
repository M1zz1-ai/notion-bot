...
class RedisState:
    ...
    def last_json(self, *parts: str, default: Any = None) -> Any:
        ...
        Read-only and non-destructive on purpose: the Mac -> VPS brief is pushed
        with RPUSH and read here as evidence that the planner ran. Consuming it
        would make that evidence disappear on the first restart.
